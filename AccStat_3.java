...
public class AccStat_3
{
	...
	public static void main(String[] args)
	{
	    ...
	    JFrame AS_2Frame=new JFrame("ATM");     //creating frame for work
		...
		JLabel Stat_2 = new JLabel("1.   15/01/20 - RS 12,000.00");
	    Stat_2.setBounds(235,180,700,90);
		Stat_2.setForeground(new Color(255,255,0));
		Stat_2.setFont(f_1);
	    background.add(Stat_2);
		
		JLabel Stat_3 = new JLabel("2.   22/03/20 - RS 14,500.00");
	    Stat_3.setBounds(235,210,700,90);
		Stat_3.setForeground(new Color(255,255,0));
		Stat_3.setFont(f_1);
	    background.add(Stat_3);
		
		JLabel Stat_4 = new JLabel("3.   29/03/20 - RS 9,000.00");
	    Stat_4.setBounds(235,240,700,90);
		Stat_4.setForeground(new Color(255,255,0));
		Stat_4.setFont(f_1);
	    background.add(Stat_4);
		
		JLabel Stat_5 = new JLabel("4.   11/04/20 - RS 15,000.00");
	    Stat_5.setBounds(235,270,700,90);
		Stat_5.setForeground(new Color(255,255,0));
		Stat_5.setFont(f_1);
	    background.add(Stat_5);
		
		JLabel Stat_6 = new JLabel("5.   14/04/20 - RS 10,000.00");
	    Stat_6.setBounds(235,300,700,90);
		Stat_6.setForeground(new Color(255,255,0));
		Stat_6.setFont(f_1);
	    background.add(Stat_6);
		
		AS_2Frame.setVisible(true);           //it will make frame visible
		
		
		AS_2Frame.setSize(750,550);           //it will set dimension of frame
		
		
		AS_2Frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);  //program will stop if frame closed
		
		
		AS_2Frame.setLayout(null);
		
		AS_2Frame.add(background);
	}
