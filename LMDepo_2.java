...
public class LMDepo_2
{
	...
	public static void main(String[] args)
	{
	    ...
	    JFrame MONFrame=new JFrame("ATM");     //creating frame for work
		...
		JLabel LM_2 = new JLabel("1.   13/01/20 - RS 20,000.00");
	    LM_2.setBounds(235,180,700,90);
		LM_2.setForeground(new Color(255,255,0));
		LM_2.setFont(f_1);
	    background.add(LM_2);
		
		JLabel LM_3 = new JLabel("2.   15/03/20 - RS 10,000.00");
	    LM_3.setBounds(235,210,700,90);
		LM_3.setForeground(new Color(255,255,0));
		LM_3.setFont(f_1);
	    background.add(LM_3);
		
		JLabel LM_4 = new JLabel("3.   22/04/20 - RS 12,000.00");
		...
		MONFrame.setVisible(true);           //it will make frame visible
		
		
		MONFrame.setSize(750,550);           //it will set dimension of frame
		
		
		MONFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);  //program will stop if frame closed
		
		
		MONFrame.setLayout(null);
		
		MONFrame.add(background);
	}
