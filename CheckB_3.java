...
public class CheckB_3
{
	...
	public static void main(String[] args)
	{
	    ...
	    JFrame CB_2Frame=new JFrame("ATM");     //creating frame for work
		...
		JLabel BAL_2 = new JLabel("RS 15,70,000.00");
	    BAL_2.setBounds(235,180,700,90);
		BAL_2.setForeground(new Color(255,255,0));
		BAL_2.setFont(f);
	    background.add(BAL_2);
		
		CB_2Frame.setVisible(true);           //it will make frame visible
		
		
		CB_2Frame.setSize(750,550);           //it will set dimension of frame
		
		
		CB_2Frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);  //program will stop if frame closed
		
		
		CB_2Frame.setLayout(null);
		
		CB_2Frame.add(background);
	}	
}	