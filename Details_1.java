...
public class Details_1
{
	...
	public static void main(String[] args)
	{
	    ...
	    JFrame Det_1Frame=new JFrame("ATM");     //creating frame for work
		...
		Det_1Frame.setVisible(true);           //it will make frame visible
		
		
		Det_1Frame.setSize(750,550);           //it will set dimension of frame
		
		
		Det_1Frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);  //program will stop if frame closed
		
		
		Det_1Frame.setLayout(null);
		
		Det_1Frame.add(background);
	}
