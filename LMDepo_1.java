...
public class LMDepo_1
{
	...
	public static void main(String[] args)
	{
	    ...
	    JFrame LMFrame=new JFrame("ATM");     //creating frame for work
		...
		JLabel LM_2 = new JLabel("1.   10/01/20 - RS 10,000.00");
	    LM_2.setBounds(235,180,700,90);
		LM_2.setForeground(new Color(255,255,0));
		LM_2.setFont(f_1);
	    background.add(LM_2);
		
		JLabel LM_3 = new JLabel("2.   03/03/20 - RS 4,000.00");
	    LM_3.setBounds(235,210,700,90);
		LM_3.setForeground(new Color(255,255,0));
		LM_3.setFont(f_1);
	    background.add(LM_3);
		
		JLabel LM_4 = new JLabel("3.   30/04/20 - RS 2,000.00");
		...
		LMFrame.setVisible(true);           //it will make frame visible
		
		
		LMFrame.setSize(750,550);           //it will set dimension of frame
		
		
		LMFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);  //program will stop if frame closed
		
		
		LMFrame.setLayout(null);
		
		LMFrame.add(background);
	}
